"bundle";
System.registerDynamic("github:aurelia/html-template-element@0.3.0", ["github:aurelia/html-template-element@0.3.0/HTMLTemplateElement.min"], true, function(require, exports, module) {
  ;
  var global = this,
...
System.registerDynamic("github:aurelia/html-template-element@0.3.0/HTMLTemplateElement.min", [], false, function(__require, __exports, __module) {
  ...
  (function() {
    !function(e) {
      ...
      function o(e) {
        var t,
            n = e.ownerDocument.createElement("template"),
            r = e.attributes,
            o = r.length;
        for (e.parentNode.insertBefore(n, e); o-- > 0; )
          t = r[o], n.setAttribute(t.name, t.value), e.removeAttribute(t.name);
      ...
      function p(e) {
        ...
        if (!n.defaultView)
          return n;
        if (t = n.templateContentsOwner_, !t) {
          for (t = n.implementation.createHTMLDocument(""); t.lastChild; )
            t.removeChild(t.lastChild);
          n.templateContentsOwner_ = t;
        }
        return t;
      }
      function c(e, t, n) {
      ...
      var u = Array.prototype.forEach.call.bind(Array.prototype.forEach),
          ...
          T = "__proto__" in {},
          d = e.HTMLUnknownElement || HTMLElement,
          s = {
            get: function() {
      ...
      f || (e.HTMLTemplateElement = function() {
        ...
        var a,
            ...
            d,
            s;
        return e.templateIsDecorated_ ? !1 : (a = e, a.templateIsDecorated_ = !0, m = n(a) && f, u = m, T = !m, d = !1, m || t(a) && (a = o(e), a.templateIsDecorated_ = !0, m = f), m || (i(a), s = p(a), a.content_ = s.createDocumentFragment()), r ? a.instanceRef_ = r : T ? c(a, e, d) : u && l(a.content), !0);
...
define("github:aurelia/validation@0.3.0/resources/zh-CN", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/validation/utilities", ["exports"], function(exports) {
  'use strict';
  exports.__esModule = true;
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/tr-TR", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+)(?:\,\d+)?$/},
    messages: {
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/sv-SE", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+)(?:\,\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/nn-NO", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/nl-NL", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+)(?:\,\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/nl-BE", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+)(?:\,\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/nb-NO", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/fr-FR", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+)(?:\,\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/es-MX", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+)(?:\,\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/en-US", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/de-DE", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+)(?:\,\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/da-DK", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/ca-ES", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/validation@0.3.0/resources/bg-BG", ["exports", "github:aurelia/validation@0.3.0/validation/utilities"], function(exports, _validationUtilities) {
  'use strict';
  exports.__esModule = true;
  var data = {
    settings: {'numericRegex': /^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/},
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("github:aurelia/loader@0.9.0/aurelia-loader", ["exports", "npm:core-js@0.9.18", "github:aurelia/path@0.9.0", "github:aurelia/metadata@0.8.0"], function(exports, _coreJs, _aureliaPath, _aureliaMetadata) {
  'use strict';
  exports.__esModule = true;
